...
(function() {
  var anyCamera, cameraState, cameraSwitch, capture, clearPlayback, frameBack, frameBeginning, frameEnd, frameForward, frameRegistry, getRandomId, loadFrames, loadSprites, makeUnselectable, menu, overlayClass, pause, placeFrame, playbackClass, playbackFrames, playbackTimeouts, recording, rescanThumbnails, saveCanvas, saveFrameSequence, startSamlite, startSimlite, switchToPlaybackMode, switchToRecordMode, thumbnailScaleFactor, toggleCamera, toggleMenu, toggleMode, trash, updateIndexView;
