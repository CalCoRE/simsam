...
from home.util import ListField
...
class AnimationFrame(ImageWrapper):
    ...
    # constants
    #image_directory = "sitestatic/media/sam_frames/" #use this for local
    image_directory = "/home/chrism/simsam/sitestatic/media/sam_frames/" #use this for dax
